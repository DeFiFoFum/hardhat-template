 ...
 */
 export function convertAddressesToExplorerLinks(addressObject: any, getLink: (address: string) => string, detailedInfo = false) {
    // Using an internal function to allow for deep copying before
    function _convertAddressesToExplorerLinks(_addressObject: any, _getLink: (address: string) => string, _detailedInfo = false) {
